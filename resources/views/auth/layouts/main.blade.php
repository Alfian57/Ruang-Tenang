...
<body class="min-h-screen bg-gray-50 flex flex-col lg:flex-row">
    ...
    <div class="flex-1 bg-primary-400 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden relative order-1 lg:order-2 min-h-[300px] lg:min-h-screen">
        <!-- Background Text -->
        <div class="px-4 sm:px-8 md:px-16 lg:px-24 text-justify hidden md:block">
            <h2 class="text-white text-center text-2xl sm:text-3xl lg:text-[40px] font-medium mb-2 lg:mb-4">RuangTenang</h2>
